...
<title>WDV341 Unit 5 Form Handler</title>
</head>

<body>
<h1>WDV341 Unit 5 Form Handler</h1>
...
<h3>Instructions</h3>
<ol>
  <li>Place the file name 'FormHandler.php' in the action attribute of your form. This is using the default pathname and will look for this file in the same location as the form.html page. You may place server side processes in their own folder on the server.  It is common to use a folder called 'files' which contains server side processes. In that case you would include the pathname in your action attribute. Example: action='files/demonstrateFormHandler.php' </li>
  ...
  <li>Complete the form and clinock Submit.</li>
</ol>
